...
const SeoContent: React.FC = () => {
  return (
    <div className="max-w-5xl mx-auto px-4 py-16 bg-gradient-to-br from-white via-slate-50 to-primary/5 rounded-3xl shadow-2xl border border-primary/10">
      ...
      <Section title="CV Nedir ve Neden Önemlidir?" icon={<FaLightbulb />}>
        <p>
      ...
      <Section title="CV Oluşturmanın Temel Adımları" icon={<FaCheckCircle />}>
      ...
      <Section title="Popüler CV Platformları ve Şablonları" icon={<FaFilePdf />}>
        <p>
      ...
      <Section title="Farklı Alanlar İçin CV Hazırlama" icon={<FaUserGraduate />}>
        <p>
      ...
      <Section title="Yapay Zeka ve Otomasyon ile CV Oluşturma" icon={<FaRobot />}>
        <p>
      ...
      <Section title="Sıkça Sorulan Sorular ve İpuçları" icon={<FaQuestionCircle />}>
      ...
      <Section title="CV’ni Güçlendirecek Ekstra Tüyolar" icon={<FaStar />}>
        <ul className="list-disc pl-6 space-y-2">
      ...
      <Section title="Sonuç: Herkes İçin Uygun, Ücretsiz ve Profesyonel CV Oluşturma" icon={<FaGlobeEurope />}>
        <p>
